...
document.querySelector(".git").style.color = "#000";
document.querySelector(".contact-content, .contact-conten a").style.color = "#000";
...
switchElement.addEventListener("click", function () {
    ...
    if (isWhiteBg) {
        ...
        document.querySelector(".contact-content, .contact-conten a").style.color = "#f5f5f5";
        document.querySelector(".git").style.color = "#f5f5f5";
