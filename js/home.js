...
document.querySelector(".parent-arrow-down .arrow-down a i").style.color = "#000";
document.querySelector(".title-home").style.color = "#000";
...
switchElement.addEventListener("click", function () {
    ...
    if (isWhiteBg) {
        ...
        document.querySelector(".list-items ul li a").style.color = "#f5f5f5";
        document.querySelector(".my-name").style.color = "#f5f5f5";
        document.querySelector(".hero-title").style.color = "#f5f5f5";
        document.querySelector(".title-home").style.color = "#f5f5f5";
        document.querySelector(".footer div h6").style.color = "#f5f5f5";
        document.querySelector(".footer .copy-right").style.color = "#f5f5f5";
        document.querySelector(".parent-arrow-down .arrow-down a i").style.color = "#f5f5f5";
        ...
        document.querySelector(".my-name").style.color = "#000";
        document.querySelector(".hero-title").style.color = "#000";
